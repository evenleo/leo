...
//获取浮点类型键值对
float Config::getFloat(const std::string& section, const std::string& key, const float& default_value)
{
...
std::vector<std::string> Config::getStringList(const std::string& section, const std::string& key)
{
...
//获取整型类型键值对
unsigned Config::getNumber(const std::string& section, const std::string& key, unsigned default_value)
{
    auto it = configs_.find(section);
    if (it != configs_.end())
    {
...
bool Config::isSection(std::string line, std::string& section)
{
    section = trim(line);
...
unsigned Config::parseNumber(const std::string& s)
{
...
std::string Config::trimLeft(const std::string& s)
{
...
std::string Config::trimRight(const std::string& s)
{
...
//设置配置文件所在路径
bool Config::setPath(const std::string& path)
{
    return Load(path); //加载文件
}
